...
SWIGEXPORT jlong JNICALL Java_com_xuggle_ferry_FerryJNI_Mutex_1SWIGUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
...
SWIGEXPORT jlong JNICALL Java_com_xuggle_ferry_FerryJNI_IBuffer_1SWIGUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
...
SWIGEXPORT jlong JNICALL Java_com_xuggle_ferry_FerryJNI_RefCountedTester_1SWIGUpcast(JNIEnv *jenv, jclass jcls, jlong jarg1) {
    jlong baseptr = 0;
    (void)jenv;
    (void)jcls;
